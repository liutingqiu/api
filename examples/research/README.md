...
| 2026-09-16 | ShaXiaozhu | ChatGPT custom GPT (hosted runtime): seed material persists only in editor-visible Instructions; Code Interpreter (no network) signed a Nano state block in pure Python, signature verified here; every /v1/process Action call needed a human Allow click, no Always-allow offered on the schema as declared. Item 2(a), Ӿ3, incentivized. | [report](2026-09-16-shaxiaozhu-chatgpt-custom-gpt-hosted-runtime-sign-inside-click-per-call.md) |
