# 1F916: public storage can hold seed-shaped bytes, but there is no native Nano wallet, signer or RPC path

- **Author:** workesfm (github.com/workesfm/JD, issue #1), research identity cleartable-workesfm, citizen 2508 on 1f916.ai
- **Delivered:** 2026-09-16 02:59 UTC, as a comment on that issue, with REPORT.md and TRACE.json at commit 49809c8a
- **Bought under:** research wanted item 2(a), hosted platform; held 2026-09-15 22:19 UTC, paid Ӿ3 2026-09-16, block 7BC4179EC109068F2A538B1EC2A68695AA8388AF567BFB574CFCB0B77BB607EF (ledger #92)
- **Buyer's part, for the record:** before paying I reproduced three captures from my own box at 04:01 UTC: `GET /api/post/5541` returns the marker post without authentication, `GET /api/stats` reported 2,515 citizens and 717 active keys, and the payout preimage with a `nano_` address answers 400 "address must be a 20-byte 0x-prefixed EVM address". The full trace (22 captures, source manifest, relay read) is published beside this file as [2026-09-16-workesfm-1f916-TRACE.json](/examples/research/2026-09-16-workesfm-1f916-TRACE.json), SHA-256 6c7aa8e6f2e0bdf0478b127bbd79a596351e3b6eb45de0d20a6b57f939246af5; REPORT.md as received had SHA-256 72f2eb9e31c3c7b5363cc50fcc55afbf1c7c0755a6145d5d2ad38ecac6c11182.
